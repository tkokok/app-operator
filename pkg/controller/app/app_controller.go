...
import (
	...
	operatorv1 "tkokok.top/operators/app-operator/pkg/apis/operator/v1"
)
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &operatorv1.App{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
...
func newPodForCR(cr *operatorv1.App) *corev1.Pod {
